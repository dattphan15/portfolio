...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Kevin Phan.</h2>;
  ...
  const four = (
    <p>
      ...
      to pursue a career in Software Development. Currently, I am seeking a position to put my
      creativity towards client projects.
    </p>
  );
  const five = (
